...
const AuthSignUp = (props: any) => {
    ...
    const onPressNext = async () => {
        ...
        const params = {
            ...
            birthday,
            type,
            addressRegion: region[addressRegion.row].regCode,
            addressProvince: province[addressProvince.row].provCode,
            addressCity: city[addressCity.row].citymunCode,
            addressBarangay: barangay[addressBarangay.row].brgyCode,
            email,
            password,
            confirmPassword
        }
